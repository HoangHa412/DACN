               ...
               <>
                  <div className="p-4">
                     <div className="container">
                        <h3>Chào mừng đến với Ứng dụng Quản lý Sinh viên!</h3>
                        <br />
                        <Row>
                           <Col flex="520px">
                              <Link to={`/profile`}>
                           ...
                           <Col flex="200px">
                              <Row>
                                 <Card style={{ width: 240, height: 145 }} onClick={onClick} hoverable>
                                    <AppstoreTwoTone
                                       twoToneColor="#205ec9"
                                       style={{ fontSize: '40px', display: 'inline-block', verticalAlign: 'middle' }}
                                    />
                                    <br />
                                    <br />
                                    <h5>{classWrapper.curClass ? 'Đổi lớp' : 'Chọn lớp'}</h5>
                                 </Card>
                              </Row>
                              <br />
                     ...
                     <>
                        <div className="p-4">
                           <div className="container">
                              ...
                              <br></br>
                              <h5>
                                 Vui lòng liên hệ với admin hệ thống và nhà trường để được thêm vào trang lớp học của
                                 bạn.
                              </h5>
                           </div>
                        </div>
