...
function StudentInfoTable(props) {
   ...
   return (
      <div>
         <Row>
            <Col flex="auto">
               <h2>Thông tin thành viên lớp</h2>
            </Col>
            <Col flex="250px">
               <p align="right">
         ...
         <Table columns={columns} dataSource={data} bordered scroll={{ x: 'calc(700px + 50%)', y: 500 }} />
         <Modal title="Thông tin cá nhân" visible={state.visible} onCancel={handleCloseModal} footer={[]} width="800px">
            <StudentProfile Id={state.currentRow._id} />
         </Modal>
         <Modal title="Thêm sinh viên" visible={state.visibleAdding} onCancel={handleCloseModalAdding} footer={[]}>
            <AddStudentForm />
         </Modal>
         <Modal
