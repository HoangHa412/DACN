      ...
      <div className="p-4" style={{ overflow: 'auto' }}>
         ...
         <Row>
            <Col flex="300px">
               ...
               <br />
               <br /> <UploadForm columns={upload_form_teacher} formurl="http://localhost:3000/api/upload/dscv" />{' '}
               <br />
            </Col>
            <Col flex="300px">
               ...
               <br />
               <br /> <UploadForm columns={upload_form_student} formurl="http://localhost:3000/api/upload/dssv" />{' '}
               <br />
               <i>
                  <b>Lưu ý:</b> Các sinh viên sẽ chưa được thêm lớp. Yêu cầu CVHT tạo lớp và thêm tại bảng Thông tin SV.{' '}
               </i>
               <br />
            </Col>
            <Col flex="300px">
         ...
         <Row>
            <Col flex="300px">
               ...
               <br />
               <br /> <UploadForm columns={upload_form_semester} formurl="http://localhost:3000/api/semesters/upload" />
            </Col>
            <Col flex="300px">
